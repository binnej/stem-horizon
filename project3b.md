...
Je microbit zal ook moeten nagaan welke waarde de variabele *kleur* heeft. Je kan nagaan of het getal in een variabele gelijk gelijk is aan een getal. Bij ``||Logic: Logisch||`` vind je het blokje ``||Logic: 0 = 0||``. Je kan het ronde ``||Variables: kleur||`` blokje in het vakje met 0 slepen. 
